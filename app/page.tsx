    ...
    <div className="min-h-screen bg-[var(--bg-primary)]">
      ...
      <section className="py-16 bg-[var(--bg-primary)] reveal">
        <div className="max-w-7xl mx-auto px-4 md:px-8 lg:px-16">
          <h2 className="font-heading font-black text-3xl md:text-4xl mb-2">FAQ</h2>
          <p className="font-body text-gray-600 dark:text-gray-400 mb-6">Common questions about this guide.</p>
          <NeoAccordion
            exclusive
            accent="#FFE500"
      ...
      {showLostModal && <FeelingLostModal onClose={() => setShowLostModal(false)} />}
    </div>
  )
}
