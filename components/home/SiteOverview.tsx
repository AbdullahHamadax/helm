  ...
  return (
    <section className="py-16 bg-[var(--bg-primary)]">
      <div className="max-w-7xl mx-auto px-4 md:px-8 lg:px-16">
        <h2 className="font-heading font-black text-3xl md:text-4xl mb-2 reveal">
          What&apos;s inside
        </h2>
        <p className="font-body text-gray-600 dark:text-gray-400 mb-8 reveal">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 md:gap-6">
          {pages.map((page, i) => {
            ...
            return (
              <NeoCard
                key={page.href}
                className={`p-6 flex flex-col reveal stagger-${i + 1} group`}
                accent={page.accent}
              >
                <div
                ...
                <p className="font-body text-sm text-gray-600 dark:text-gray-400 flex-1 mb-4">
                  {page.description}
                </p>
                <NeoButton
                  href={page.href}
